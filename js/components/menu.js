...
let pageNames = ["Accueil", "Page 2", "Page 3"]; // Ajouter autant de pages que souhaité en ajoutant un nom dans le tableau
// Nom de pages (langue supplémentaire)
// let pageNamesSecondaryLanguage = ["Homepage", "Page 2"]

let pageLinks = ["../index.html", "../page2.html", "../page3.html"]; // Links to the different pages (has to be in order)
